...
export class AuthService{
  ...
  constructor(private fireauth: AngularFireAuth, private firestore: AngularFirestore, 
    private router: Router, public dialog: MatDialog, private spinnerService: SpinnerService, 
    private storage: AngularFireStorage, public uploadService: UploadServiceService) {}
 ...
 */
  showActualUser() {
    this.actualUser$ = this.fireauth.authState.pipe( //returns observable that emits the currently
    //authenticated user
      switchMap(actualUser => { //transform one observable into another
  ...
  loadAndSubscribeCurrentProfilPicture(actualUser: firebase.default.User) {
    ...
    this.profilePictureSubscription = this.profilPicture.subscribe((url: string) => {
 ...
 */
   ...
   */
  async updateEmail(user: firebase.default.User, newEmail: string, newUserName: string) {
 ...
 */
  successfulSignUp(data: Object, res: firebase.default.auth.UserCredential, email: string) {
